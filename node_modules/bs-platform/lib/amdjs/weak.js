'use strict';
define(["exports", "./array.js", "./curry.js", "./caml_obj.js", "./caml_weak.js", "./caml_array.js", "./caml_int32.js", "./pervasives.js", "./js_primitive.js", "./caml_primitive.js", "./caml_builtin_exceptions.js"],
  function(exports, $$Array, Curry, Caml_obj, Caml_weak, Caml_array, Caml_int32, Pervasives, Js_primitive, Caml_primitive, Caml_builtin_exceptions){
    'use strict';
    ...
    function Make(H) {
        ...
        return $$Array.fold_right((function (param, param$1) {
                      ...
                      while(true) {
                        ...
                        if (i >= b.length) {
                          ...
                          if (match !== undefined) {
                            _accu = Curry._2(f, Js_primitive.valFromOption(match), accu);
                            _i = i + 1 | 0;
                            continue ;
                          } else {
                            _i = i + 1 | 0;
        ...
        return $$Array.iter((function (param) {
                      ...
                      while(true) {
                        ...
                        if (i >= b.length) {
                          ...
                          var match = Caml_weak.caml_weak_get(b, i);
                          if (match !== undefined) {
                            Curry._1(f, Js_primitive.valFromOption(match));
                            _i = i + 1 | 0;
                            continue ;
                          } else {
                            _i = i + 1 | 0;
      ...
      var add = function (t, d) {
        ...
        return add_aux(t, Caml_weak.caml_weak_set, Js_primitive.some(d), h, get_index(t, h));
      };
      var find_or = function (t, d, ifnotfound) {
        ...
        while(true) {
          ...
          if (i >= sz) {
            ...
            if (match !== undefined) {
              if (Curry._2(H[/* equal */0], Js_primitive.valFromOption(match), d)) {
      ...
      var merge = function (t, d) {
        return find_or(t, d, (function (h, index) {
                      add_aux(t, Caml_weak.caml_weak_set, Js_primitive.some(d), h, index);
                      return d;
                    }));
      };
