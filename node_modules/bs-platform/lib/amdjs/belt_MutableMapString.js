'use strict';
define(["exports", "./curry.js", "./js_primitive.js", "./belt_internalAVLtree.js", "./belt_internalMapString.js"],
  function(exports, Curry, Js_primitive, Belt_internalAVLtree, Belt_internalMapString){
    'use strict';
    function make() {
      return {
    ...
    function updateDone(t, x, f) {
      if (t !== null) {
        ...
        if (k === x) {
          ...
          if (match !== undefined) {
            t.value = Js_primitive.valFromOption(match);
            return t;
          } else {
            var l = t.left;
            var r = t.right;
