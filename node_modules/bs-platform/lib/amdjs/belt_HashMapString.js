'use strict';
define(["exports", "./js_primitive.js", "./caml_hash_primitive.js", "./belt_internalBuckets.js", "./belt_internalBucketsType.js"],
  function(exports, Js_primitive, Caml_hash_primitive, Belt_internalBuckets, Belt_internalBucketsType){
    'use strict';
    ...
    function get(h, key) {
      ...
      if (match !== undefined) {
        if (key === match.key) {
          return Js_primitive.some(match.value);
        } else {
          var match$1 = match.next;
          if (match$1 !== undefined) {
            if (key === match$1.key) {
              return Js_primitive.some(match$1.value);
            } else {
              var match$2 = match$1.next;
              if (match$2 !== undefined) {
                if (key === match$2.key) {
                  return Js_primitive.some(match$2.value);
                } else {
                  var key$1 = key;
                  ...
                  while(true) {
                    ...
                    if (buckets !== undefined) {
                      if (key$1 === buckets.key) {
                        return Js_primitive.some(buckets.value);
                      } else {
