'use strict';
define(["exports", "./list.js", "./block.js", "./curry.js", "./caml_bytes.js", "./pervasives.js", "./caml_string.js", "./js_primitive.js", "./caml_exceptions.js", "./camlinternalLazy.js", "./caml_builtin_exceptions.js"],
  function(exports, List, Block, Curry, Caml_bytes, Pervasives, Caml_string, Js_primitive, Caml_exceptions, CamlinternalLazy, Caml_builtin_exceptions){
    'use strict';
          ...
          switch (d.tag | 0) {
            ...
            case 3 : 
                ...
                if (match$1 !== undefined) {
                  var match$2 = Js_primitive.valFromOption(match$1);
                  ...
                  if (match$3 !== undefined) {
                    ...
                    g[/* curr */0] = Js_primitive.some(undefined);
                    return /* Sempty */0;
                  }
                }
            case 4 : 
          ...
          switch (match.tag | 0) {
            ...
            case 4 : 
                ...
                if (b[/* len */2] === 0) {
                  ...
                  return Js_primitive.some(b[/* buff */1][b[/* ind */3]]);
                }
    ...
    function nget(n, s) {
      if (n <= 0) {
        ...
        var match = peek(s);
        if (match !== undefined) {
          var a = Js_primitive.valFromOption(match);
          junk(s);
