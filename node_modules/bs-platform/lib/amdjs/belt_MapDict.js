'use strict';
define(["exports", "./curry.js", "./js_primitive.js", "./belt_internalAVLtree.js"],
  function(exports, Curry, Js_primitive, Belt_internalAVLtree){
    'use strict';
    ...
    function updateU(t, newK, f, cmp) {
      if (t !== null) {
        ...
        if (match$1 !== undefined) {
          return Belt_internalAVLtree.singleton(newK, Js_primitive.valFromOption(match$1));
        } else {
          return t;
        }
      }
      ...
      if (s1 !== null) {
        if (s2 !== null) {
          if (s1.height >= s2.height) {
            ...
            var newD = f(v1, Js_primitive.some(d1), d2$1);
            ...
            var newD$1 = f(v2, d1$2, Js_primitive.some(d2$2));
          ...
          return Belt_internalAVLtree.keepMapU(s1, (function (k, v) {
                        return f(k, Js_primitive.some(v), undefined);
                      }));
        }
      } else if (s2 !== null) {
        return Belt_internalAVLtree.keepMapU(s2, (function (k, v) {
                      return f(k, undefined, Js_primitive.some(v));
                    }));
      } else {
        return Belt_internalAVLtree.empty;
      }
